...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            alert()->error($e->getMessage(), 'خطا')->persistent("فهمیدم!");

            return redirect()->back();
        }

        alert()->success('دسته بندی مورد نظر ایجاد شد', 'تبریک')->persistent("خیلی خب!");
    ...
    public function update(Request $request, Category $category)
    {
        ...
        alert()->success('دسته بندی مورد نظر ویرایش شد', 'تبریک')->persistent("خیلی خب!");
